...
const [appliedJobs, setAppliesJob] = useState([]);
...
displayJobs.map(job => <li key={job.id}> <span>{job.job_title} {job.job_title} : {job.remote_or_onsite}</span></li>)
//  appliedJobs.map(job => (
//         <li key={job.id}></li>))
}
